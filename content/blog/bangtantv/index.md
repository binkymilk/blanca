...
![Number of views in BANGTANTV by year](views-per-time-comeback.png)
...
![Relationship between likes and views](rel-view-likes.png)
...
![Relationship between comments and views](rel-view-comments.png)
